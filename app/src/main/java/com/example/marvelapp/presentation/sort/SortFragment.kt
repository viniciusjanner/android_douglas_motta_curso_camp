...
class SortFragment : BottomSheetDialogFragment() {
    ...
    private fun setChipGroupListeners() {
        ...
        binding.buttonApplySort.setOnClickListener {
            viewModel.actionApplySorting(orderBy, order)
        }
    }
    ...
    private fun getOrderByValue(chipId: Int): String =
        when (chipId) {
            R.id.chipName -> SortingType.ORDER_BY_NAME.value

            R.id.chipModified -> SortingType.ORDER_BY_MODIFIED.value
    ...
    private fun getOrderValue(chipId: Int): String =
        when (chipId) {
            R.id.chipAscending -> SortingType.ORDER_ASCENDING.value

            R.id.chipDescending -> SortingType.ORDER_DESCENDING.value
